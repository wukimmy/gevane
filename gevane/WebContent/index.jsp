					...
					<div class="content">
						<div class="btn-controls">
							<div class="btn-box-row row-fluid">
								<a href="estoque.jsp" class="btn-box big span4"> <i
									class=" icon-random"></i>
									<p class="text-muted">Estoque</p>
								</a> <a href="venda.jsp" class="btn-box big span4"> <i
									class="icon-money"></i>
									<p class="text-muted">Vendas</p>
								</a> <a href="usuario.jsp" class="btn-box big span4"> <i
									class="icon-user"></i>
